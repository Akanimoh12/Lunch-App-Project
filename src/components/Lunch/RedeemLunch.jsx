...
export default function RedeemLunch() {
  ...
  return (
    <div className="min-h-screen bg- p-4 flex flex-col items-center relative sm:bg-[#710193] ">


      <div className=" sm:w-[390px] w-full bg-white h-[60vh] sm:rounded-2xl ">

        {/* Background Overlay */}
        <div className="absolute inset-0 h-auto bg-opacity-50 "></div>
        ...
        {/* Redeem Lunch Modal */}
        <div className="absolute bottom-2 sm:w-[390px] w-[92%] h-[543px] bg-[#FFFCFD] sm:rounded-2xl p-6  z-20">
          <button
