  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[#FFFCFD] font-sans">
      <div className="bg-[#FFFCFD] w-full max-w-[390px] h-[100vh] max-h-[844px] rounded-lg sm:shadow-lg p-4 flex flex-col justify-between overflow-hidden">
        ...
        {/* Lunch Card */}
        <div className="mb-10">
        <div className=" text-[#FFFCFD] rounded-lg p-3 text-center mb-3">
          <img src="/images/Frame 43.png" alt="" className="w-[342px] h-[118px]"/>
          <p className="text-[11px] mt-2 text-gray-500 rounded-4px border border-dotted h-[29px] border-[#EABA00]">🎁 Congratulations! You received a free lunch. Great job!😍</p>
        </div>
